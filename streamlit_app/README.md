...
- Username: `onlyahmad`
- Password: `only$ahmad#2025`

## Configuration

Voice transcription needs OpenAI credentials. Sign in as admin and add these
under **Application Secrets** (or set them as environment variables):
